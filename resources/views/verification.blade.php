        ...
        <table class="top-panel center" width="602" border="0" cellspacing="0" cellpadding="0">
            <tbody>
                <tr>
                    ...
                    <td class="subject" width="300"><a class="strong" href="https://daafyapp.com/" target="_blank">www.DaafyApp.com</a></td>
                </tr>
                <tr>
                            ...
                            <tbody>
                                <tr>
                                    <td class="padded">
                                        ...
                                        <p style="text-align:center;"><a href="{{$url}}" class="btn">Verify Email
                                                Address</a></p>
                                        <p>If you're having trouble clicking the "Verify Email Address" button, copy and
                                            paste the URL below into your web browser:</p>
                                        <p style="text-align:center;">
                                            <a href="{{$url}}" class="strong">{{$url}}</a>
                                        </p>
                                    </td>
                                </tr>
                            </tbody>
